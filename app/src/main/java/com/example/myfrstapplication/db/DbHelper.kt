...
class DbHelper(context: Context) :
    ...
    private fun insertInitialData(db: SQLiteDatabase) {
        ...
        android.content.ContentValues().apply {
            put(Columns.AUTHOR, "мода бегемота")
            ...
            put(Columns.PUBLISHED, "13 мая в 07:22")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
        ...
        android.content.ContentValues().apply {
            put(Columns.AUTHOR, "мода бегемота")
            put(Columns.AUTHOR_ID, 7)
            put(Columns.CONTENT, "Носки с сандалиями — это не про комфорт, а про смелость быть собой. Такой стиль ломает стереотипы, привлекает внимание и показывает, что ты не боишься экспериментов. Это выбор тех, кто ценит индивидуальность выше чужих мнений. В конце концов, круто не то, что принято, а то, что ты носишь с уверенностью.")
            put(Columns.PUBLISHED, "13 мая в 07:22")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
        ...
        android.content.ContentValues().apply {
            ...
            put(Columns.CONTENT, "Ваш автомобиль заслуживает лучшего! Современный гаражный комплекс «Свежесть» — это надёжная защита, комфорт и удобство для вашего авто. Безопасность 24/7: круглосуточная охрана, видеонаблюдение и доступ по пропускам. Идеальные условия: сухость, чистота и оптимальная температура круглый год. Удобное расположение: легко добраться из любой части города. Дополнительные сервисы: зарядка электромобилей, мойка и техническое обслуживание. С «Свежестью» вы всегда уверены в сохранности своего автомобиля. Выбирайте надёжность и комфорт!")
            put(Columns.PUBLISHED, "23 мая в 19:00")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
            put(Columns.VIEWS, 18900)
        ...
        android.content.ContentValues().apply {
            ...
            put(Columns.CONTENT, "Пока город спит, вы выходите на пробежку по просторным, хорошо освещённым паркингам комплекса. Здесь нет машин, только свежий воздух и безопасность. Ровные дорожки, отсутствие городского шума и суеты — идеальные условия для того, чтобы зарядиться энергией и настроиться на продуктивный день. Ваша лучшая пробежка начинается там, где комфорт встречается с заботой о себе. Гаражный комплекс — территория вашего утреннего старта.")
            put(Columns.PUBLISHED, "01 мая в 04:40")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
            put(Columns.VIEWS, 18900)
        ...
        android.content.ContentValues().apply {
            put(Columns.AUTHOR, "шашлычная на газу & почему бы и нет")
            put(Columns.AUTHOR_ID, 11)
            put(Columns.CONTENT, "Лучшие майские праздники начинаются с компании друзей и жареного на мангале мяса. Классический шашлык из свинины Ингредиенты: Свиная шея — 2 кг. Лук — 2 кг. Соль, чёрный перец, кориандр, лавровый лист. Как готовить: Мясо нарезать кусками, лук — полукольцами. Перемешать с солью и специями, помять руками. Мариновать 4–12 часов. Жарить на углях 15–20 минут, часто переворачивая. Подавать с зеленью и свежими овощами.")
            put(Columns.PUBLISHED, "1 мая в 00:12")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
            put(Columns.VIEWS, 18900)
        ...
        android.content.ContentValues().apply {
            ...
            put(Columns.CONTENT, "Открытие своего дела в гараже — это отличная идея для старта! Минимальные вложения, свобода творчества и возможность работать в собственном ритме. Гараж становится не просто помещением, а настоящей лабораторией идей, где рождаются проекты и воплощаются мечты. Здесь можно смело экспериментировать, не боясь ошибок, и постепенно превращать любимое дело в успешный бизнес.")
            put(Columns.PUBLISHED, "04 мая в 12:42")
            put(Columns.LIKED_BY_ME, 0)
            put(Columns.LIKES, 9250)
            put(Columns.SHARES, 5420)
            put(Columns.VIEWS, 18900)
