...
class PostRepositoryInMemoryImpl : PostRepository {
    ...
    private var posts = listOf(
        ...
        Post(
            ...
            author = "почему бы и нет",
            authorId = 9,
            content = "Пока город спит, вы выходите на пробежку по просторным, хорошо освещённым паркингам комплекса. Здесь нет машин, только свежий воздух и безопасность. Ровные дорожки, отсутствие городского шума и суеты — идеальные условия для того, чтобы зарядиться энергией и настроиться на продуктивный день. Ваша лучшая пробежка начинается там, где комфорт встречается с заботой о себе. Гаражный комплекс — территория вашего утреннего старта.",
